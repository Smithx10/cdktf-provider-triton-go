...
import (
	...
	"github.com/Smithx10/cdktf-provider-triton-go/triton/volume/internal"
...
func (j *jsiiProxy_Volume) FilesystemPath() *string {
	var returns *string
	_jsii_.Get(
		j,
		"filesystemPath",
...
func (j *jsiiProxy_Volume) Networks() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"networks",
...
func (j *jsiiProxy_Volume) NetworksInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"networksInput",
...
func (j *jsiiProxy_Volume) State() *string {
	var returns *string
	_jsii_.Get(
		j,
		"state",
...
func (j *jsiiProxy_Volume) Tags() *map[string]*string {
...
func (j *jsiiProxy_Volume) TagsInput() *map[string]*string {
	var returns *map[string]*string
	_jsii_.Get(
		j,
		"tagsInput",
...
func NewVolume(scope constructs.Construct, id *string, config *VolumeConfig) Volume {
	...
	_jsii_.Create(
		"@cdktf/provider-triton.volume.Volume",
...
func (j *jsiiProxy_Volume)SetNetworks(val *[]*string) {
...
func (j *jsiiProxy_Volume)SetTags(val *map[string]*string) {
...
func (v *jsiiProxy_Volume) ResetNetworks() {
	_jsii_.InvokeVoid(
		v,
		"resetNetworks",
		nil, // no parameters
