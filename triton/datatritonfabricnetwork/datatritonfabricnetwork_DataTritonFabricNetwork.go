...
import (
	...
	"github.com/Smithx10/cdktf-provider-triton-go/triton/datatritonfabricnetwork/internal"
...
func (j *jsiiProxy_DataTritonFabricNetwork) Count() interface{} {
...
func (j *jsiiProxy_DataTritonFabricNetwork)SetCount(val interface{}) {
