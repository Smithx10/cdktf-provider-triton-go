...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataTritonFabricNetwork)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-triton.dataTritonFabricNetwork.DataTritonFabricNetworkConfig",
		reflect.TypeOf((*DataTritonFabricNetworkConfig)(nil)).Elem(),
	)
}
