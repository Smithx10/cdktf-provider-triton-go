...
import (
	...
	"github.com/cdktf/cdktf-provider-triton-go/triton/datatritonimage/internal"
...
func (j *jsiiProxy_DataTritonImage) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataTritonImage)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
