...
import (
	...
	"github.com/Smithx10/cdktf-provider-triton-go/triton/snapshot/internal"
...
func (j *jsiiProxy_Snapshot) MachineId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"machineId",
...
func (j *jsiiProxy_Snapshot) MachineIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"machineIdInput",
...
func NewSnapshot(scope constructs.Construct, id *string, config *SnapshotConfig) Snapshot {
	...
	_jsii_.Create(
		"@cdktf/provider-triton.snapshot.Snapshot",
...
func (j *jsiiProxy_Snapshot)SetMachineId(val *string) {
	if err := j.validateSetMachineIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
