...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*InstanceTemplate)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-triton.instanceTemplate.InstanceTemplateConfig",
		reflect.TypeOf((*InstanceTemplateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-triton.instanceTemplate.InstanceTemplateTimeouts",
		reflect.TypeOf((*InstanceTemplateTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-triton.instanceTemplate.InstanceTemplateTimeoutsOutputReference",
		reflect.TypeOf((*InstanceTemplateTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
