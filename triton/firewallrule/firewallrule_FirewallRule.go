...
import (
	...
	"github.com/Smithx10/cdktf-provider-triton-go/triton/firewallrule/internal"
...
func (j *jsiiProxy_FirewallRule) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_FirewallRule) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_FirewallRule) Global() cdktf.IResolvable {
...
func (j *jsiiProxy_FirewallRule) Rule() *string {
	var returns *string
	_jsii_.Get(
		j,
		"rule",
...
func (j *jsiiProxy_FirewallRule) RuleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"ruleInput",
...
func NewFirewallRule(scope constructs.Construct, id *string, config *FirewallRuleConfig) FirewallRule {
	...
	_jsii_.Create(
		"@cdktf/provider-triton.firewallRule.FirewallRule",
...
func (j *jsiiProxy_FirewallRule)SetEnabled(val interface{}) {
...
func (j *jsiiProxy_FirewallRule)SetRule(val *string) {
...
func (f *jsiiProxy_FirewallRule) ResetEnabled() {
	_jsii_.InvokeVoid(
		f,
		"resetEnabled",
		nil, // no parameters
